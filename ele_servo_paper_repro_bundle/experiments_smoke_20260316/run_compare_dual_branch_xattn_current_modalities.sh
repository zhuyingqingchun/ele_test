...
SAVE_DIR="${SAVE_DIR:-${PROJECT_ROOT}/experiments_smoke_20260316/models/traditional_compare_current_modalities/dual_branch_xattn}"
...
"${PYTHON_PATH}" experiments_smoke_20260316/train_timeseries_baseline_randomsplit.py \
  ...
  --device "${DEVICE}" \
  --save-dir "${SAVE_DIR}" \
  --run-name dual_branch_xattn_current_modalities
