...
EXPERIMENT_FLAGS=(
  "--zero-electrical --zero-thermal --zero-vibration"
  "--zero-pos --zero-thermal --zero-vibration"
  "--zero-pos --zero-electrical --zero-vibration"
  "--zero-pos --zero-electrical --zero-thermal"
)
