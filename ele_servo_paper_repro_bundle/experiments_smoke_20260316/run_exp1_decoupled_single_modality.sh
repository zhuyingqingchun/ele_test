...
ROOT_OUT_DIR="${ROOT_OUT_DIR:-${PROJECT_ROOT}/experiments_smoke_20260316/models/exp1_decoupled_v4_single_modality_raw_thermal}"
...
run_one "only_position" "--zero-electrical --zero-thermal --zero-vibration"
run_one "only_electrical" "--zero-pos --zero-thermal --zero-vibration"
run_one "only_thermal" "--zero-pos --zero-electrical --zero-vibration"
run_one "only_vibration" "--zero-pos --zero-electrical --zero-thermal"
